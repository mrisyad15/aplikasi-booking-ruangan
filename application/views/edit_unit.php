          ...
          <ul class="list-unstyled">
			...
			<div class="content-inner">
			  ...
			  <header class="page-header">
				<div class="container-fluid">
				  <h2 class="no-margin-bottom">Edit Divisi</h2>
				</div>
			  </header>
			  <!-- Breadcrumb-->
			  <div class="breadcrumb-holder container-fluid">
				<ul class="breadcrumb">
				  <li class="breadcrumb-item"><a href="<?php echo base_url('index.php/admin/unit'); ?>">Divisi</a></li>
					...
					<div class="col-lg-12">
					  <div class="card">
						...
						<div class="card-header d-flex align-items-center">
						  <h3 class="h4">Edit Divisi</h3>
						</div>
						<div class="card-body">
						  <p><font face="pristina" size="6px">Silahkan Ubah Data Anda !!!</font></p>
						  <form action="<?=site_url('admin/update_unit')?>" method="post">

							<div class="form-group">
							  <label class="form-control-label">ID Divisi</label>
							  <input type="text" name="id_unit" value="<?=$data->id_unit?>" class="form-control" readonly>
							</div>

							<div class="form-group">
							  <label class="form-control-label">Divisi</label>
							  <input type="text" name="nm_unit" class="form-control" value="<?=$data->nm_unit?>">
							</div>



							<div class="form-group">
							  <button type="submit" name="update_user" class="btn btn-primary btn-lg">Ubah</button>
