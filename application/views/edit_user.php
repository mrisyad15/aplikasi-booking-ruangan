						...
						<div class="card-body">
						  ...
						  <input type="hidden" name="id" value="<?=$value->id_user?>">
							<div class="form-group">
							  ...
							  <input type="text" name="nm_user" value="<?=$value->nm_user?>" class="form-control">
							</div>
							...
							<div class="form-group row">
							  <label class="col-sm-3 form-control-label">Nama Divisi</label>
							  <div class="col-sm-9">
								<!-- <select name="nm_unit" class="form-control" required>
								  <option value="">Silahkan Pilih</option>
								  <?php
									foreach ($unit as $key) {
								  echo "<option value='".$key->id_unit."'>".$key->nm_unit."</option>";
								  }
								  echo"
								</select>"
								?> -->
