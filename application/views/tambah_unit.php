          ...
          <ul class="list-unstyled">
			...
			<div class="content-inner">
			  ...
			  <header class="page-header">
				<div class="container-fluid">
				  <h2 class="no-margin-bottom">Tambah Divisi</h2>
				</div>
			  </header>
			  <!-- Breadcrumb-->
						...
						<div class="col-lg-12">
						  <div class="card">
							...
							<div class="card-body">
							  ...
							  <form action="<?=site_url('admin/add_unit')?>" method="post" enctype="multipart/form-data">
								<div class="form-group">
								  <label class="form-control-label">ID Divisi</label>
								   <input type="text" name="id_unit" class="form-control" readonly="">
								</div>
