          ...
          <ul class="list-unstyled">
			...
			<div class="content-inner">
			  ...
			  <section class="forms">
						...
						<div class="col-lg-12">
						  <div class="card">
							...
							<div class="card-body">
							  ...
							  <form action="<?=site_url('admin/add_booking/')?>" method="post" enctype="multipart/form-data">
								<div class="form-group">
								  <label class="form-control-label">ID Booking</label>
								  <input type="text" name="id_booking"  class="form-control" readonly="">
								</div>

                <div class="form-group row">
								  <label class="col-sm-3 form-control-label">Nama Pilih User</label>
								  <div class="col-sm-9">
									<select name="nm_user" class="form-control mb-3" required>
                ...
                <div class="form-group row">
								  <label class="col-sm-3 form-control-label">Nama Ruang</label>
								  <div class="col-sm-9">
									<select name="nama_ruang" class="form-control mb-3" required>
									  <option value="">Silahkan Pilih Ruang</option>
                      <?php                                
