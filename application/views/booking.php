		  ...
		  <div class="row">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="<?=base_url('index.php/admin/edit_booking/').$key->id_booking?>" class="btn btn-info">Edit</a>
                    <a href="<?=base_url('index.php/admin/Delete_booking/').$key->id_booking?>" class="btn btn-danger">Delete</a>
                  </td>
                </tr>
              <?php } ?>
              </tbody>
