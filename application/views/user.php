				...
				<div class="col-lg-12">
				  ...
				  <div class="card">
					...
					<div class="card-header d-flex align-items-center">
					  <h3 class="h4"><a href="<?php echo base_url('index.php/admin/Add_data/user')?>" class="btn btn-primary">Tambah</a></h3>
					</div>
					<div class="card-body">
							...
							<tbody>
										  ...
										  ?>
											<tr>
											  ...
											  <td>
												<a href="<?=base_url('index.php/admin/edit_user/').$key->id_user?>" class="btn btn-info">Edit</a>
												<a href="<?=base_url('index.php/admin/Delete_user/').$key->id_user?>" class="btn btn-danger">Delete</a>
												</td>
											</tr>
										  <?php } ?>
							</tbody>
