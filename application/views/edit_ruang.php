					...
					<div class="col-lg-12">
					  <div class="card">
						...
						<div class="card-body">
						  ...
						  <form action="<?=site_url('admin/update_ruang')?>" method="post">

							<div class="form-group">
							  <label class="form-control-label">ID Ruangan</label>
							  <input type="text" name="id_ruang" value="<?=$data->id_ruang?>" class="form-control" readonly>
							</div>
