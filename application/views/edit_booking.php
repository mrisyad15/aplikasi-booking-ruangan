          ...
          <ul class="list-unstyled">
			...
			<div class="content-inner">
			  ...
			  <header class="page-header">
				<div class="container-fluid">
				  <h2 class="no-margin-bottom">Edit Name</h2>
				</div>
			  </header>
			  <!-- Breadcrumb-->
					...
					<div class="col-lg-12">
					  <div class="card">
						...
						<div class="card-header d-flex align-items-center">
						  <h3 class="h4">Edit Name</h3>
						</div>
						<div class="card-body">
						  <p><font face="pristina" size="6px">Silahkan Ubah Data Anda !!!</font></p>
						  <form action="<?=site_url('admin/update_booking')?>" method="post">

							<div class="form-group">
							  <label class="form-control-label">ID Booking</label>
							  <input type="text" name="id" value="<?=$data->id_booking?>" class="form-control" readonly>
							</div>
              ...
              <div class="form-group row">
							  ...
							  <div class="col-sm-9">
								<select name="id_user" class="form-control" required>
								  <option value="<?=$data->id_user ?>"><?=$data->nm_user ?></option>
                    <?php
                    foreach ($user as $key) {
                    echo "<option value='".$key->id_user."'>".$key->nm_user."</option>";
                    }
                    echo"
                    </select>"
                    ?>
							...
							<div class="form-group">
							  ...
							  <input type="date" name="tgl_booking" class="form-control" value="<?=$data->tgl_booking?>">
							</div>
              ...
              <div class="form-group row">
							  <label class="col-sm-3 form-control-label">Nama Ruangan</label>
							  <div class="col-sm-9">
                      ...
                      ?>
							...
							<div class="form-group">
							  <button type="submit" name="update_booking" class="btn btn-primary btn-lg">Ubah</button>
