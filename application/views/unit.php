  ...
  <body>
	...
	<div class="content-inner">
	  ...
	  <header class="page-header">
		<div class="container-fluid">
		  <h2 class="no-margin-bottom">Divisi</h2>
		</div>
	  </header>
	  <!-- Breadcrumb-->
	  ...
	  <section class="tables">
		<div class="container-fluid">
			...
			<div class="col-lg-12">
			<a href="<?=base_url('index.php/admin/Add_data/unit')?>" class="btn btn-primary btn-lg">Tambah</a>
                  <div class="card">
              ...
              ?>
                <tr>
                  ...
                  <td><?=$key->nm_unit;?></td>
                  <td>
                    <a href="<?=base_url('index.php/admin/edit_unit/').$key->id_unit?>" class="btn btn-info">Edit</a>
                    <a href="<?=base_url('index.php/admin/Delete_unit/').$key->id_unit?>" class="btn btn-danger">Delete</a>
                  </td>
                </tr>
              <?php } ?>
              </tbody>
