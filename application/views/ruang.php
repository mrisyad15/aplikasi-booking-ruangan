  ...
  <body>
	...
	<div class="content-inner">
	  ...
	  <div class="breadcrumb-holder container-fluid">
		<ul class="breadcrumb">
		  <li class="breadcrumb-item"><a href="<?php echo base_url('index.php/welcome'); ?>">Home</a></li>
	  ...
	  <section class="tables">
		<div class="container-fluid">
		  <div class="row">
				...
				<div class="col-lg-12">
				  <a href="<?=base_url('index.php/admin/Add_data/ruang')?>" class="btn btn-primary btn-lg"><i class="glyphicon glyphicon-plus"></i>Tambah</a>
				  <div class="card">
							...
							<tbody>
							  ...
							  ?>
								<tr>
								  ...
								  <td>
                    <a href="<?=base_url('index.php/admin/edit_ruang/').$key->id_ruang?>" class="btn btn-info">Edit</a>
                    <a href="<?=base_url('index.php/admin/Delete_ruang/').$key->id_ruang?>" class="btn btn-danger">Delete</a>
                </td>
								</tr>
							  <?php } ?>
							  </tbody>
